...
public:
  ...
  int getLastNbIterations() {
    if(pOptimizer)
      return pOptimizer->getLastNbIterations();
    else
      return 0;
  }
...
class ToolboxOCCRF: public ToolboxCRF
{
public:
  ToolboxOCCRF();
  virtual ~ToolboxOCCRF();
...
class ToolboxOCHCRF: public ToolboxHCRF
{
public:
  ToolboxOCHCRF();
  ToolboxOCHCRF(int nbHiddenStates);
  virtual ~ToolboxOCHCRF();
