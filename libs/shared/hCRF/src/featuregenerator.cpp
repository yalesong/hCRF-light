...
FeatureType::FeatureType():idOffset(0), nbFeatures(0), idOffsetPerLabel(0), 
nbFeaturesPerLabel(0), strFeatureTypeName(), featureTypeId(0), layer(0)
{}
FeatureType::FeatureType(int l):idOffset(0), nbFeatures(0), idOffsetPerLabel(0), 
nbFeaturesPerLabel(0), strFeatureTypeName(), featureTypeId(0), layer(l)
{}
